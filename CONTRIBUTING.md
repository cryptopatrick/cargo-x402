# Contributing to cargo-x402
First off, thank you for considering contributing to cargo-x402. 
It's people like you that make cargo-x402 great!
...
To run cargo-x402, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/cargo-x402/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/cargo-x402/issues) to report any bugs or request new features.
...
Thank you for contributing to cargo-x402!
